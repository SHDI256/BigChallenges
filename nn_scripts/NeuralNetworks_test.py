...
if __name__ == '__main__':
    ...
    andrei_antonovic_image = face_recognition.load_image_file("/home/user/Desktop/BIgChallenges/gleb/gallery/Andrei_1.jpg")
    ...
    while True:
        ...
        if detector.check_distance(image, depth) < 3.5:
            detector.update_points(image)
            print('Detecting point')

            mas = detector.frequent_breath() + [detector.hand_with_phone(), detector.hand_face(), detector.head_rotate()] + detector.eye_detection() + [detector.correcting_clothes()]
            try:
                transfer.open()
